      ...
      >
        <PageWrapper maxW="1000px" flexDir="column" px={{ base: 2, md: 5 }} pt={{ base: 2, md: 4 }}>
          <Flex align="center" justify="space-between" mb={4}>
            <Flex justify="center">
              <Link href={`${getLandingPageUrl()}?utm_source=public-dashboard&utm_campaign=${domain}`}>
            ...
            <Flex align="center" gap="4">
              ...
              <Link href={`${getAppUrl()}/signup`} _hover={{ textDecoration: 'none' }}>
                ...
                {isFilterableDataLoading ? (
                  ...
                  >
                    ...
                    <Flex
                      ...
                      align="center"
                    >
                      <FilterContainer filterConfig={filterConfig} from="/$domain" />
                      <Flex flexGrow={1} gap={2.5} justify="flex-end">
                        <AddFilterButton from="/$domain" filterConfig={filterConfig} />
                        <TimespanSelect from="/$domain" />
                      </Flex>
                    </Flex>
                  </Flex>
                )}
          ...
          <Flex mt={12} mb={6} flexDir="column" align="center" justify="center" gap={2}>
            ...
            <Text fontSize="sm">
              <Link
                href={`${getAppUrl()}/signup?utm_source=public-dashboard&utm_campaign=${domain}`}
                fontWeight="medium"
                color="purple.fg"
              >
                Sign up
